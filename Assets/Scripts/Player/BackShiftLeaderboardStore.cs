...
/// leaderboard UI can read BackShiftLeaderboard from PlayerPrefs and display
/// these rows or replace this with cloud-backed storage.
/// </summary>
public static class BackShiftLeaderboardStore
{
    public const string Key = "BackShiftLeaderboard";
